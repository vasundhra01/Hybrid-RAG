...
# This script does not use the LLM's knowledge to answer the questions if it cannot find the answer from the provided context. 

# This script is used for evaluation purpose of the hybrid RAG chatbot that forces the AI to answer questions strictly from the retrieved context, preventing it from using its own knowledge.

# The conversation data is stored to "evaluation_data.json" 
